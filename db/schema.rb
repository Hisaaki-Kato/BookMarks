...
ActiveRecord::Schema.define(version: 20_200_609_053_529) do
  create_table 'boards', force: :cascade do |t|
    ...
    t.integer 'book_id'
    t.string 'title'
    t.index %w[user_id created_at], name: 'index_boards_on_user_id_and_created_at'
  ...
  create_table 'comments', force: :cascade do |t|
    ...
    t.index %w[user_id micropost_id created_at], name: 'index_comments_on_user_id_and_micropost_id_and_created_at'
  end
